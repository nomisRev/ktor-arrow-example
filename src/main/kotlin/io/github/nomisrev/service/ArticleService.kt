...
fun articleService(
    ...
    object : ArticleService {
        ...
        override suspend fun deleteComment(
            ...
            val comment = articlePersistence.findComment(commentId)
            ensureNotNull(comment) { CommentNotFound(commentId) }
            ensure(comment.author == userId.serial) { NotCommentAuthor(userId.serial, commentId) }
